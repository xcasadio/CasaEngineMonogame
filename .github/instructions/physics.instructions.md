---
name: physics
description: Règles propres à la physique CasaEngine (backend bepuphysics2, synchronisation des transforms, debug draw).
applyTo: "{CasaEngine/Engine/Physics/**,CasaEngine/Framework/Physics/**,CasaEngine/Framework/Application/Components/Physics/**}"
---
