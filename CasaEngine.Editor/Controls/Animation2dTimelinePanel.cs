...
internal sealed class Animation2dTimelinePanel
{
    ...
    public Animation2dTimelinePanel(MGWindow window)
    {
        _window = window;
    }
    ...
    private void RefreshContent()
    {
        ...
        {
            _root.TryAddChild(new MGTextBlock(_window, "No Animation2D timeline available.")
            {
        ...
        _root.TryAddChild(_activeInspectorPanel.CreateTimelineContent());
    }
}