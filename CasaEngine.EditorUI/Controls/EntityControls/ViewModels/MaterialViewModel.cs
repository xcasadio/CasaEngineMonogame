...
public class MaterialViewModel : NotifyPropertyChangeBase
{
    ...
    /// <summary>
    /// Asset content manager used to reload textures after saving.
    /// Set from <see cref="StaticModelSubMeshComponentViewModel"/> after creation.
    /// </summary>
    public AssetContentManager? ContentManager { get; set; }
    ...
    // -------------------------------------------------------------------------
    // Texture reload (override in sub-classes)
    // -------------------------------------------------------------------------

    /// <summary>
    /// Reloads textures from <see cref="ContentManager"/> after a save.
    /// Sub-classes override to handle their specific texture properties.
    /// </summary>
    protected virtual void ReloadTextures() { }
    ...
    /// then reloads textures so the viewport reflects the change immediately.
    /// </summary>
