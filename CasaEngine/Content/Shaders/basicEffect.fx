...
BEGIN_PER_FRAME
    ...
    float3 DirLight0Direction _vs(c4) _ps(c5) _cb(c0);
    float3 DirLight0DiffuseColor _vs(c5) _ps(c6) _cb(c1);
    float3 DirLight0SpecularColor _vs(c6) _ps(c7) _cb(c2);

    float3 DirLight1Direction _vs(c7) _ps(c8) _cb(c3);
    float3 DirLight1DiffuseColor _vs(c8) _ps(c9) _cb(c4);
    float3 DirLight1SpecularColor _vs(c9) _ps(c10) _cb(c5);

    float3 DirLight2Direction _vs(c10) _ps(c11) _cb(c6);
    float3 DirLight2DiffuseColor _vs(c11) _ps(c12) _cb(c7);
    float3 DirLight2SpecularColor _vs(c12) _ps(c13) _cb(c8);
