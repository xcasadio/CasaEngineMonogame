...
namespace CasaEngine.Core.Extension;

public static class XMLExtension
{
    public static void Read(this XmlElement xmlEl_, ref Color c_)
    {
    ...
    public static void Read(this XmlElement xmlEl_, ref Vector4 v_)
    {
    ...
    public static void Read(this XmlElement xmlEl_, ref BoundingBox b_)
    {
        ((XmlElement)xmlEl_.SelectSingleNode("Min")).Read(ref b_.Min);
        ((XmlElement)xmlEl_.SelectSingleNode("Max")).Read(ref b_.Max);
    }

    public static void Read(this XmlElement xmlEl_, ref Vector3 v_)
    {
        v_.X = float.Parse(xmlEl_.Attributes["x"].Value, CultureInfo.InvariantCulture.NumberFormat);
        v_.Y = float.Parse(xmlEl_.Attributes["y"].Value, CultureInfo.InvariantCulture.NumberFormat);
        v_.Z = float.Parse(xmlEl_.Attributes["z"].Value, CultureInfo.InvariantCulture.NumberFormat);
    ...
    public static void Read(this XmlElement xmlEl_, ref Vector2 v_)
    {
        v_.X = float.Parse(xmlEl_.Attributes["x"].Value, CultureInfo.InvariantCulture.NumberFormat);
        v_.Y = float.Parse(xmlEl_.Attributes["y"].Value, CultureInfo.InvariantCulture.NumberFormat);
    }

    public static void Read(this XmlElement xmlEl_, ref Matrix m_)
    {
    ...
    public static void Read(this XmlElement xmlEl_, ref Quaternion q_)
    {
    ...
    public static void Read(this XmlElement xmlEl_, ref Rectangle r_)
    {
    ...
    public static void Read(this XmlElement xmlEl_, ref Point p_)
    {
    ...
    public static XmlElement AddRootNode(this XmlDocument xmlDoc_, string nodeName_)
    {
    ...
    public static void AddAttribute(this XmlDocument xmlDoc_, XmlElement xmlElement_, string attributeName_, string value_)
    {
    ...
    public static XmlElement CreateElementWithText(this XmlDocument xmlDoc_, string nodeName_, string val_)
    {
    ...
    public static XmlElement CreateElement(this XmlDocument xmlDoc_, string nodeName_, Color c_)
    {
    ...
    public static XmlElement CreateElement(this XmlDocument xmlDoc_, string nodeName_, Vector2 v_)
    {
    ...
    public static XmlElement CreateElement(this XmlDocument xmlDoc_, string nodeName_, Vector3 v_)
    {
        XmlAttribute att1 = xmlDoc_.CreateAttribute("x");
        att1.Value = v_.X.ToString(CultureInfo.InvariantCulture.NumberFormat);
        XmlAttribute att2 = xmlDoc_.CreateAttribute("y");
    ...
    public static XmlElement CreateElement(this XmlDocument xmlDoc_, string nodeName_, Vector4 v_)
    {
        XmlAttribute att1 = xmlDoc_.CreateAttribute("x");
        att1.Value = v_.X.ToString(CultureInfo.InvariantCulture.NumberFormat);
        XmlAttribute att2 = xmlDoc_.CreateAttribute("y");
    ...
    /// <param name="b_"></param>
    public static XmlElement CreateElement(this XmlDocument xmlDoc_, string nodeName_, BoundingBox b_)
    {
        XmlElement el = xmlDoc_.CreateElement(nodeName_);
    ...
    /// <param name="nodeName_"></param>
    /// <param name="q_"></param>
    public static XmlElement CreateElement(this XmlDocument xmlDoc_, string nodeName_, Quaternion q_)
    {
        Vector4 v = new Vector4(q_.X, q_.Y, q_.Z, q_.W);
        return xmlDoc_.CreateElement(nodeName_, v);
    }
    ...
    /// <param name="nodeName_"></param>
    /// <param name="m_"></param>
    public static XmlElement CreateElement(this XmlDocument xmlDoc_, string nodeName_, Matrix m_)
    {
    ...
    /// <param name="nodeName_"></param>
    /// <param name="v_"></param>
    public static XmlElement CreateElement(this XmlDocument xmlDoc_, string nodeName_, Rectangle r_)
    {
        XmlAttribute att1 = xmlDoc_.CreateAttribute("x");
    ...
    public static XmlElement CreateElement(this XmlDocument xmlDoc_, string nodeName_, Point p_)
    {
        XmlAttribute att1 = xmlDoc_.CreateAttribute("x");
