...
namespace CasaEngine.Core.Game
{
    public static class GameExtension
    {
        ...
        {
            var component = GetGameComponent<T>(game);
        ...
        {
            if (GetGameComponent<T>(game) is GameComponent gc)
            {
                gc.Enabled = state;
                return true;
            }
        ...
        {
            var drawableGameComponent = GetDrawableGameComponent<T>(game);
