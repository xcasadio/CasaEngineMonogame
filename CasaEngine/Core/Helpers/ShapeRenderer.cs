...
namespace CasaEngine.Core.Helpers
{
    public class ShapeRenderer : DebugView, IDisposable
    {
        ...
        public ShapeRenderer(FarseerPhysics.Dynamics.World world) : base(world)
        {
            ...
            LoadContent(Framework.Game.Engine.Instance.Game.GraphicsDevice, Framework.Game.Engine.Instance.SpriteBatch, Framework.Game.Engine.Instance.DefaultSpriteFont);
