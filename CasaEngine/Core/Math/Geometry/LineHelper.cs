...
public static class LineHelper
{
    ...
    public static bool LineIntersect2(ref Vector2 a0, ref Vector2 a1, ref Vector2 b0, ref Vector2 b1, out Vector2 intersectionPoint)
    {
        ...
        if (System.Math.Abs(denom) < MathUtils.Epsilon)
        {
    ...
    public static List<Vector2> LineSegmentVerticesIntersect(ref Vector2 point1, ref Vector2 point2, List<Vector2> vertices)
    {
