...
namespace CasaEngine.Engine.Primitives3D
{
    ...
    partial
#endif
    class Geometric3DPrimitive : IDisposable
    {
        Geometric3DPrimitiveType m_Type;
        ...
        /// 
        /// </summary>
        protected Geometric3DPrimitive(Geometric3DPrimitiveType type_)
        {
            m_Type = type_;
        }
		...
		static public Geometric3DPrimitive Load(GraphicsDevice graphicDevice_, BinaryReader binR_, bool linearize)
		{
		...
		/// <returns></returns>
		static public Geometric3DPrimitive Load(GraphicsDevice graphicDevice_, XmlElement el_)
		{
