...
public class PathPlanner<T> where T : WeightedEdge
{
    ...
    public bool RequestPathToPosition(Vector3 position)
    {
        ...
        {
            MessageManagerRouter.Instance.SendMessage(0, owner.Owner.Id, 0, (int)MessageType.PathReady, null);
            return true;
        }
    ...
    protected internal SearchState CycleOnce()
    {
        ...
        {
            MessageManagerRouter.Instance.SendMessage(0, owner.Owner.Id, 0, (int)MessageType.PathNotAvailable, null);
        }
