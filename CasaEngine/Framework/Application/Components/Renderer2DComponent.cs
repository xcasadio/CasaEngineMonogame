...
public class Renderer2DComponent : DrawableGameComponent, IViewFlushableRenderer
{
    ...
    /// <summary>
    /// Fallback for when the multi-view pipeline is not active.
    /// The pipeline calls <see cref="Flush"/> directly; this override is only
    /// reached when the queues were not already drained by Flush().
    /// </summary>
