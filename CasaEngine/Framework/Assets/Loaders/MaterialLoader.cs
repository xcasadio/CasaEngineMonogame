...
public class MaterialLoader : IAssetLoader
{
    ...
    public object? LoadAsset(string fileName, AssetContentManager assetContentManager)
    {
        try
        {
            ...
            if (material is UnlitTextureMaterial unlit && unlit.AlbedoAssetId != Guid.Empty)
            {
                var tex = assetContentManager.Load<Assets.Textures.Texture>(unlit.AlbedoAssetId);
                unlit.Albedo = tex?.Resource;
            }
