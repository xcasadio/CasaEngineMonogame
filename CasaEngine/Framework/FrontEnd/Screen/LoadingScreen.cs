        ...
        : Screen
    {
                                                       ...
                                                       bool coveredByOtherScreen)
        {
            ...
            if (_otherScreensAreGone)
            {
                ...
                Game.Engine.Instance.Game.ResetElapsedTime();
            }
        }
        ...
        public override void Draw(float elapsedTime)
        {
            ...
            if (_loadingIsSlow)
            {
                ...
                var viewport = Game.Engine.Instance.GraphicsDeviceManager.GraphicsDevice.Viewport;
                var viewportSize = new Vector2(viewport.Width, viewport.Height);
                var textSize = Game.Engine.Instance.DefaultSpriteFont.MeasureString(message);
                ...
                spriteBatch.End();*/
                _renderer2DComponent.AddText2D(Game.Engine.Instance.DefaultSpriteFont, message, textPosition, 0.0f, Vector2.One, color, 0.99f);
            }
        }
