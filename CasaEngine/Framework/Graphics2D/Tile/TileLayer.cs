...
public abstract class TileLayer
{
    ...
    {
        _displaySize.X = EngineComponents.Game.GraphicsDevice.PresentationParameters.BackBufferWidth;
        _displaySize.Y = EngineComponents.Game.GraphicsDevice.PresentationParameters.BackBufferHeight;
        VisibilityChanged = true;
    }
