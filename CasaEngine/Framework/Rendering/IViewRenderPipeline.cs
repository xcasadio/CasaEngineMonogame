...
/// <list type="bullet">
///   <item><b>DefaultViewPipeline</b> — standard game view (clear → world draw → flush).</item>
///   <item><b>EditorViewPipeline</b> — adds gizmos, grid, selection outline overlays.</item>
