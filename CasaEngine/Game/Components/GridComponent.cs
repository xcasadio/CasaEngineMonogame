...
namespace CasaEngine.Game.Components;
...
public class GridComponent : DrawableGameComponent
{
    ...
    protected override void LoadContent()
    {
        ...
        LinesVertices[i++] = new VertexPositionColor(new Vector3(-m_Size, 0.0f, 0), Microsoft.Xna.Framework.Color.DarkBlue);
        LinesVertices[i++] = new VertexPositionColor(new Vector3(m_Size, 0.0f, 0), Microsoft.Xna.Framework.Color.DarkBlue);
        LinesVertices[i++] = new VertexPositionColor(new Vector3(0, 0.0f, m_Size), Microsoft.Xna.Framework.Color.DarkBlue);
        LinesVertices[i++] = new VertexPositionColor(new Vector3(0, 0.0f, -m_Size), Microsoft.Xna.Framework.Color.DarkBlue);
