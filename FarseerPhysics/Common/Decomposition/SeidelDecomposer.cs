...
namespace FarseerPhysics.Common.Decomposition
{
    ...
    /// See also: "Computational Shape", 3rd edition, by Mark de Berg et al, Chapter 6.2
    ///           "Computational Shape in C", 2nd edition, by Joseph O'Rourke
    /// </summary>
    ...
    internal class MonotoneMountain
    {
        ...
        // See "Computational Shape in C", 2nd edition, by Joseph O'Rourke, page 52
        public void Process()
        {
    ...
    // See "Computational Shape", 3rd edition, by Mark de Berg et al, Chapter 6.2
