...
| --- | --- | --- |
| [asset-handles-tasks.md](tasks/asset-handles-tasks.md) | Ressources comptées avec libération différée, polices bitmap comme ressources et registre de polices du jeu (ADR-0036) | Plan écrit le 2026-09-21, en attente d'approbation, relu **READY** (enveloppe après un REVISE corrigé, puis première tranche) : T0.1 ✅, T1.1–T4.1 ⏳. Né d'un défaut trouvé en jeu par le portage Alundra (textes de l'inventaire hors de `font3` après un changement de carte) ; la recette visible est la tranche D5.f du plan parent. |
