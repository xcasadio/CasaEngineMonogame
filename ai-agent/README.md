...
| --- | --- | --- |
| [audio-stereo-voices-mute-tasks.md](tasks/audio-stereo-voices-mute-tasks.md) | Voix stéréo logicielles aux gains gauche/droite exacts, modifiables pendant la lecture, et son coupé porté par les réglages du projet (ADR-0039, ADR-0040) | Approuvé le 2026-09-25 (mode AUTO). T1 ✅ (plan et ADR) ; T2 (voix stéréo) et T3 (son coupé) ⏳. Consommateur : plan parent `docs/plan-audio-mix-exact-muet.md` (T1.1 à T1.4). |
