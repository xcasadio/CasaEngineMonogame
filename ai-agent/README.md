...
| [mgui-package-alignment-tasks.md](tasks/mgui-package-alignment-tasks.md) | Alignement sur la mise à jour du sous-module MGUI : packages MonoGame et FontStashSharp, renommage des namespaces de brushes, packages de test, outils `dotnet-mgcb` | Plan approuvé le 2026-09-13 (révision 2 : FontStashSharp épinglé en 1.5.7 dans MGUI, base MGUI `df22af7`), en cours : T1.1 ✅, T1.2 → T1.6 ⏳. Branche `fix/mgui-package-versions`. |
