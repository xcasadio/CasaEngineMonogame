...
| --- | --- | --- |
| [bound-screens-tasks.md](tasks/bound-screens-tasks.md) | Programme « écrans liés » : les écrans d'un jeu deviennent des assets du projet liés à des view-models observables ; images nommées par asset (sprites et animations 2D) résolues par l'hôte ; binding MGUI sans allocation ; aller-retour sans perte et aperçu avec données de conception dans l'éditeur ; écran de dialogue remplaçable (ADR-0038, MGUI ADR-0016, parent ADR-0002) | Plan écrit le 2026-09-24, en attente d'approbation : T0.1 ✅, T1.1–T7.1 ⏳. Consommateur : plan parent `docs/plan-bound-screens.md` (B1–B5). |
