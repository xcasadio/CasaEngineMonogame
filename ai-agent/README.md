...
| --- | --- | --- |
| [bound-screens-tasks.md](tasks/bound-screens-tasks.md) | Programme « écrans liés » : les écrans d'un jeu deviennent des assets du projet liés à des view-models observables ; images nommées par asset (sprites et animations 2D) résolues par l'hôte ; binding MGUI sans allocation ; aller-retour sans perte et aperçu avec données de conception dans l'éditeur ; écran de dialogue remplaçable (ADR-0038, MGUI ADR-0016, parent ADR-0002) | Approuvé le 2026-09-24 (mode AUTO) ; phases 1 à 7 faites. **Phase 8 faite** (réponses de l'auteur D13 à D18), chaque tâche vérifiée CONFIRMED : T6.2 dialogue incomplet, T4.4 « Save » enregistre les écrans (prouvé sur les écrans d'Alundra par B6), T4.5 confirmation avant de perdre un écran modifié, T4.6 Ctrl+S. Reste en 🧪, vérifications visuelles de l'auteur : T2.3 (sample « Bound Images »), T4.3 (sélecteur d'image de l'inspecteur), T4.5 (vrais clics Yes/No/Cancel, sample de docking), T4.6 (vrai Ctrl+S). Points à arbitrer par l'auteur : O3, O5 (O6 tranché par D13) ; merges MGUI develop, moteur main, parent main sur feu vert de l'auteur (D16). Consommateur : plan parent `docs/plan-bound-screens.md` (B1–B6). |
