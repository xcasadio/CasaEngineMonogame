...
| --- | --- | --- |
| [asset-handles-tasks.md](tasks/asset-handles-tasks.md) | Ressources comptées avec libération différée, polices bitmap comme ressources et registre de polices du jeu (ADR-0036) | Plan écrit le 2026-09-21, approuvé et exécuté le 2026-09-21 (mode AUTO) : T0.1–T4.1 ✅, `CasaEngine.Tests` 1738/1739 (seul échec préexistant, hors périmètre), `MGUI.Tests` 2989/2989 ; recette Alundra D5.f passée (font3 chargée une seule fois, gardée à travers le changement de carte). Reste : vérification finale, puis archivage et merge à la décision de l'auteur. Né d'un défaut trouvé en jeu par le portage Alundra (textes de l'inventaire hors de `font3` après un changement de carte) ; la recette visible est la tranche D5.f du plan parent. |
