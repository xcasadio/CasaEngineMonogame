...
| [tilemap-render-spaces-tasks.md](tasks/tilemap-render-spaces-tasks.md) | Espaces de rendu TileMap (Camera2d ortho, pixel-perfect, tilemap 3D, RT→quad, viewport 2D éditeur) | Plan entier ⏳ (phases A–F). |
