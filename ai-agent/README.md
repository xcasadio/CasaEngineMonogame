...
| --- | --- | --- |
| [screen-effect-above-ui-tasks.md](tasks/screen-effect-above-ui-tasks.md) | Effet d'écran au-dessus de l'interface MGUI (couche `AboveUI` du `ScreenEffectService`, crochet post-interface dans la composition, smoke dans `TileMapDemo`) | Plan rédigé le 2026-09-19, révision 3 après deux relectures adverses, **en attente d'approbation de l'auteur**. Né du portage Alundra (plan E13, D-E13-11). Six tâches ⏳. |
