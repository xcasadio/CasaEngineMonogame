...
- **2D** : chemin séparé avec sa propre clé de tri lexicographique à 7 champs ([RenderSortKey2D](CasaEngine/Framework/Rendering/Depth/RenderSortKey2D.cs) : passe 2D, sorting layer, ordre, élévation, coordonnée Y-sort, offset, id stable) — conçu pour les tilemaps avec profondeur (cf. [docs/engine/tilemaps-gestion-profondeur.md](docs/engine/tilemaps-gestion-profondeur.md)).
