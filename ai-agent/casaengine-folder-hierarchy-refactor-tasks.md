...
- la stratégie de compatibilité des namespaces conservés est documentée dans `docs/architecture/CasaEngine_folder_hierarchy_namespace_compatibility.md`
...
- l'évaluation du split par projets est documentée dans `docs/architecture/CasaEngine_layering_project_split_evaluation.md`
