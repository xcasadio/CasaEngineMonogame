...
- `LIGHTVIS-006` dans `ai-agent/light-component-editor-visualization-tasks.md`
- `Valider le flux d'edition material` dans `ai-agent/material-inspector-stability-plan.md`
...
1. Reporter le resultat dans `ai-agent/light-component-editor-visualization-tasks.md` sous `LIGHTVIS-006`.
2. Reporter le resultat dans `ai-agent/material-inspector-stability-plan.md` sur la tache `Valider le flux d'edition material`.
