...
Moderniser le systeme d'animation 2D de CasaEngine autour de deux besoins verifies dans la note [docs/editor/animation2d_editor_casaengine.md](../../docs/editor/animation2d_editor_casaengine.md) :
...
La note de [docs/editor/animation2d_editor_casaengine.md](../../docs/editor/animation2d_editor_casaengine.md) pose une bonne direction fonctionnelle : une animation 2D moderne ne doit pas etre limitee a une succession d'images completes. Les notions de parties, attachments, ordre d'affichage, pistes, keyframes et events correspondent bien au besoin de composer plusieurs images.
...
- Surface concrete documentee dans `ai-agent/audits/animation2d-editor-surface-notes.md`.
...
- Documentation ajoutee dans `docs/engine/animation2d-composed-format-v1.md`.
