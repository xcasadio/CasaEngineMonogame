...
- `ai-agent/tasks/archive/material-system-modernization-tasks.md` pour la migration materials deja livree
- `ai-agent/tasks/archive/material-inspector-stability-plan.md` pour la validation editeur encore ouverte
- `docs/engine/materials-workflow.md` pour l'etat final de l'architecture
