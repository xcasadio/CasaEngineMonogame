...
Validation : `dotnet build .\CasaEngine.Editor\CasaEngine.Editor.csproj -c Debug --no-restore`
Notes : documentation développeur ajoutée dans `docs/editor/editor-workspace-layouts.md`; validation finale limitée au build ciblé, sans scénario UI automatisé
