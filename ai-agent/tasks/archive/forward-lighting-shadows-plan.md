...
- `docs/engine/light-component.md`
- `ai-agent/tasks/archive/forward-lighting-shadows-plan.md`
- Tests si un manque de couverture est identifie.

Etapes detaillees :

1. Mettre a jour `docs/engine/light-component.md` pour expliquer `CastShadows` sur lights.
...
- `docs/engine/light-component.md` documente maintenant `LightComponent.CastShadows`, les flags `CastShadows` / `ReceiveShadows` des composants rendus, et la regle effective composant && material.
