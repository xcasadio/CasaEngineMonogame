...
- ✅ **T01.01 - Cartographier les sources de verite material/shader**
  ...
  Livrable :
  - Une note d'audit courte dans `ai-agent/` ou `docs/engine/` avec un tableau `type -> role -> consommateurs -> statut`.
  Validation :
...
- ✅ **T06.03 - Mettre a jour la documentation d'architecture finale**
  Objectif :
  - Mettre a jour `docs/engine/materials-workflow.md` ou un document d'architecture associe pour refleter la source de verite finale, le contrat de hot reload, le nouveau modele de lumieres scalable et la disparition des chemins legacy et de `BasicEffect` MonoGame.
  Validation :
