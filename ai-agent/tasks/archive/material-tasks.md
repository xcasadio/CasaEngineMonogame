...
- `ai-agent/tasks/archive/material-system-modernization-tasks.md` pour la migration materials cloturee
- `ai-agent/tasks/archive/material-shader-deep-audit-tasks.md` pour l'audit et les refactors deja realises
- `docs/engine/materials-workflow.md` pour l'etat final authoring/runtime
- `ai-agent/tasks/shader-source-hot-reload-tasks.md` pour le principal manque fonctionnel restant cote shaders
