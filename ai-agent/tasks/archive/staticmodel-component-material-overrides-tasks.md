...
- `ai-agent/tasks/archive/material-system-modernization-tasks.md` T07.01 a T07.04
- `docs/engine/materials-workflow.md` pour le workflow runtime actuel des overrides par slot
