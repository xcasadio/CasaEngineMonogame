...
Source de conception : [`docs/editor/timeline-generic.md`](../../../docs/editor/timeline-generic.md) (lire la
...
- **Pas de modele cutscene plat.** Le modele cutscene reel est l'arbre d'actions
  ...
  (voir `ai-agent/tasks/cutscene-implementation-plan.md`). Aucune tache de ce plan ne cree de
...
- **Adapter cutscene plat** : abandonne. La cutscene est un arbre `Sequence`/`Parallel`
  ...
  controle d'arbre, traite par `ai-agent/tasks/cutscene-implementation-plan.md`.
