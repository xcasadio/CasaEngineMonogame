...
```powershell
git add ai-agent/tasks/mgui-native-dark-theme-plan.md
...
```powershell
git add MGUI/MGUI.Core/UI/MGTheme.cs ai-agent/tasks/mgui-native-dark-theme-plan.md
...
```powershell
git add MGUI/MGUI.Core/UI/Themes/BuiltInThemes.xaml ai-agent/tasks/mgui-native-dark-theme-plan.md
...
```powershell
git add MGUI/MGUI.Core/UI/Templates/BuiltInControlTemplates.xaml MGUI/MGUI.Core/UI/Styling/MGControlTemplateCatalog.cs ai-agent/tasks/mgui-native-dark-theme-plan.md
...
```powershell
git add MGUI/MGUI.Tests ai-agent/tasks/mgui-native-dark-theme-plan.md
...
```powershell
git add CasaEngine.Editor/GameEditor.cs ai-agent/tasks/mgui-native-dark-theme-plan.md
...
```powershell
git add CasaEngine.Editor ai-agent/tasks/mgui-native-dark-theme-plan.md
...
```powershell
git add MGUI/MGUI.Samples ai-agent/tasks/mgui-native-dark-theme-plan.md
...
```powershell
git add MGUI/Docs MGUI/README.md MGUI/MGUI.Samples/Features ai-agent/tasks/mgui-native-dark-theme-plan.md
