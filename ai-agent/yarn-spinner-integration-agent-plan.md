...
- La recherche locale n'a pas trouve de module `Dialogue`, `DialogueService`, `YarnDialogueAsset`, fichier `.yarn` ou reference Yarn hors du document `docs/yarn_spinner_integration.md`.

## Critique du document actuel

- Le document `docs/yarn_spinner_integration.md` pose une bonne direction generale : ne pas reimplementer un langage de dialogue et separer runtime narratif, UI, gameplay et outils.
...
- `docs/yarn_spinner_integration.md`
- Ce plan agent.
