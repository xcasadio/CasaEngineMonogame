...
> **On the number.** ADR-0034 was on an unmerged branch when this was written, so this record took 0035 to
> avoid colliding with it. Both landed together; the index lists them in order.
